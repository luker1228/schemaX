  ...
  <div className="contact__inner">
    <div className="contact__card">
      ...
      <div className="contact__actions">
        ...
        >
          <span className="contact__btn-icon" aria-hidden="true">✉</span>
        ...
        <a
          ...
          rel="me noopener"
        >
          <span className="contact__btn-label">GitHub →</span>
        </a>
        <a className="contact__btn" href={contactCta.rss}>
          <span className="contact__btn-label">RSS</span>
        </a>
      </div>

      <div className="contact__meta">
        <span className="contact__meta-item">{contactCta.meta.response}</span>
        <span className="contact__meta-item">{contactCta.meta.location}</span>
      </div>
    </div>
  </div>
</section>
